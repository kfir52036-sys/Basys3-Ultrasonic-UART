...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports Echo_0]					
	set_property IOSTANDARD LVCMOS33 [get_ports Echo_0]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports Trigger_0]					
	set_property IOSTANDARD LVCMOS33 [get_ports Trigger_0]
##Sch name = JA3
#set_property PACKAGE_PIN A18 [get_ports UART_0_txd]					
	#set_property IOSTANDARD LVCMOS33 [get_ports UART_0_txd]
##Sch name = JA4
#set_property PACKAGE_PIN B18 [get_ports UART_0_rxd]					
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports UART_0_rxd]					
	#set_property IOSTANDARD LVCMOS33 [get_ports UART_0_rxd]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports UART_0_txd]					
	#set_property IOSTANDARD LVCMOS33 [get_ports UART_0_txd]
##Sch name = JB3
